...
const CMConvoThankYou = () => {
  return (
    <Layout>
      <SEO
        title="thank-you"
        description="Thank you signing up to Chattermill Conversations "
      />
      <StyledSection>
        <StyledHeader>Thank You!</StyledHeader>
        <Wrapper>
          <StyledText>
            Check your inbox for a confirmation email for a demo of Chattermill
            Conversations 🎉.
          </StyledText>
          <StyledLink
            button={{
...
export default CMConvoThankYou;
