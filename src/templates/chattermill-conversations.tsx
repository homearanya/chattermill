  ...
  data: {
    ...
    site: {
      siteMetadata: {
        hubspotConfig: {
          portalId,
          chattermill_conversations_formId,
          newsletter_formId,
        },
      },
    },
        ...
        <StyledRow justify="center" align="center">
          ...
          >
            ...
            <ContactForm
              analyticsOptions={{
                category: "Sign Up",
                label: "Chattermill Conversations Signup",
              }}
              hubspotOptions={{
                portalId,
                newsletterFormId: newsletter_formId,
                formId: chattermill_conversations_formId,
              }}
              buttonText={"Sign Up"}
              actionOnSuccess={() =>
                navigate("/thank-you-chattermill-conversations/")
              }
            />
          </Col>
        </StyledRow>
...
interface PageQueryData {
  ...
  site: {
    siteMetadata: {
      hubspotConfig: {
        portalId: string
        chattermill_conversations_formId: string
