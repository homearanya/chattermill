...
const Section4 = () => {
  const { section4Header, statImg9, statImg10 } = useStaticQuery(
    graphql`
      {
        section4Header: file(
          relativePath: { eq: "cx-stats/illustration-header-section-04.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 580
        ...
        statImg9: file(
          relativePath: { eq: "cx-stats/illustration-stat-09.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
        ...
        statImg10: file(
          relativePath: { eq: "cx-stats/illustration-stat-10.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
      ...
      <div className="section-wrapper">
        <div className="section-header">
          <div className="section-header-text-container">
            <p className="section-header-title">The Future of CX Statistics</p>
          </div>
          <div className="section-header-img-container">
            <GatsbyImage image={getImage(section4Header)} alt="" />
            <div className="header-circle"></div>
          </div>
        </div>
        <div className="stats-grid sg4">
          <div className="stat-block sg4-1">
            <p className="stat-block-copy">
              <span className="bold-class">84% of consumers</span> reported
              using digital channels more frequently in 2020.
            </p>
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="84% of consumers reported using digital channels more frequently in 2020. via Chattermill">
                  <a
          ...
          <div className="stat-block sg4-2">
            <p className="stat-block-copy">
              74% say their digital experience with brands{" "}
              <span className="bold-class">has changed</span> since the
              pandemic.
            </p>
            <div className="bottom-info-container">
              <a
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="74% say their digital experience with brands has changed since the pandemic. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-3">
            <p className="stat-block-copy">
              Globally, 40% of consumers report{" "}
              <span className="bold-class">buying more online</span> than they
              used to.
            </p>
            <div className="bottom-info-container">
              <a
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Globally, 40% of consumers report buying more online than they used to. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block alt-light-blue sg4-4">
            <p className="stat-block-copy">
              68% of CMOs intend to{" "}
              <span className="bold-class">increase spending</span> on martech.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
                href="https://www.gartner.com/en/newsroom/press-releases/2020-07-01-gartner-says-cmos-remain-optimistic-about-budgets-pos"
                target="_blank"
              >
                Gartner
              </a>
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="68% of CMOs intend to increase spending on martech. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-5">
            <p className="stat-block-copy">
              25% of brands are predicted to achieve{" "}
              <span className="bold-class">
                statistically significant advances
              </span>{" "}
              in CX quality in 2021.
            </p>
            <div className="stat-img-wrapper">
              <GatsbyImage
                image={getImage(statImg9)}
                alt="Arrows pointing up next to smiling faces"
              />
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="25% of brands are predicted to achieve statistically significant advances in CX quality in 2021. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-6">
            <p className="stat-block-copy">
              81% of CX marketers predicted they would be competing{" "}
              <span className="bold-class">almost entirely on CX</span> by 2019.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
                href="https://www.gartner.com/en/marketing/insights/articles/key-findings-from-the-gartner-customer-experience-survey"
                target="_blank"
              >
                Gartner
              </a>
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="81% of CX marketers predicted they would be competing almost entirely on CX by 2019. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-7">
            <p className="stat-block-copy">
              <span className="bold-class">75% of U.S. consumers</span> tried a
              new store, brand, or shopping experience during the pandemic.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
                href="https://www.mckinsey.com/business-functions/marketing-and-sales/our-insights/understanding-and-shaping-consumer-behavior-in-the-next-normal"
                target="_blank"
              >
                McKinsey
              </a>
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="75% of U.S. consumers tried a new store, brand, or shopping experience during the pandemic. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block alt-dark-blue sg4-8">
            <p className="stat-block-copy">
              44% of marketers are focused on{" "}
              <span className="bold-class">AI and machine learning.</span>
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="44% of marketers are focused on AI and machine learning. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-9">
            <p className="stat-block-copy">
              <span className="bold-class">70% of executives</span> expect the
              pandemic to accelerate digital transformation.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
                href="https://dmexco.com/stories/is-the-coronavirus-pandemic-an-engine-for-the-digital-transformation/"
                target="_blank"
              >
                DMEXCO
              </a>
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="70% of executives expect the pandemic to accelerate digital transformation. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-10">
            <p className="stat-block-copy">
              Only <span className="bold-class">47% of executives</span> say
              they understand clearly how robotics and AI will improve customer
              experience.
            </p>
            <div className="stat-img-wrapper">
              <GatsbyImage image={getImage(statImg10)} alt="A smiling robot" />
              <div className="stat-block-img-bg"></div>
            </div>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
                href="https://www.pwc.com/gx/en/industries/consumer-markets/consumer-insights-survey.html"
                target="_blank"
              >
                PwC
              </a>
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Only 47% of executives say they understand clearly how robotics and AI will improve customer experience. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-11">
            <p className="stat-block-copy">
              82% of U.S. consumers want{" "}
              <span className="bold-class">more human interaction</span> in the
              future.
            </p>
            <div className="bottom-info-container">
              <a
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="82% of U.S. consumers want more human interaction in the future. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <div className="stat-block sg4-12">
            <p className="stat-block-copy">
              <span className="bold-class">74% of non-U.S. consumers</span> want
              more human interaction in the future.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="74% of non-U.S. consumers want more human interaction in the future. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
