...
import * as handleShare from "./util.js"
...
const Section1 = () => {
  const { section1Header, statImg1, statImg2, statImg3 } = useStaticQuery(
    graphql`
      {
        section1Header: file(
          relativePath: { eq: "cx-stats/illustration-header-section-01.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 580
        ...
        statImg1: file(
          relativePath: { eq: "cx-stats/illustration-stat-01.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
        ...
        statImg2: file(
          relativePath: { eq: "cx-stats/illustration-stat-02.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
        ...
        statImg3: file(
          relativePath: { eq: "cx-stats/illustration-stat-03.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
