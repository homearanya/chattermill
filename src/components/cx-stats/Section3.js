...
const Section3 = () => {
  const { section3Header, statImg7, statImg8 } = useStaticQuery(
    graphql`
      {
        section3Header: file(
          relativePath: { eq: "cx-stats/illustration-header-section-03.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 580
        ...
        statImg7: file(
          relativePath: { eq: "cx-stats/illustration-stat-07.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
        ...
        statImg8: file(
          relativePath: { eq: "cx-stats/illustration-stat-08.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 393
