...
const Section1 = () => {
  const { section1Header, statImg1 } = useStaticQuery(
    graphql`
      {
        section1Header: file(
          relativePath: {
            eq: "online-reviews-stats/illustration-header-section-01.png"
          }
        ) {
          childImageSharp {
            gatsbyImageData(
        ...
        statImg1: file(
          relativePath: { eq: "online-reviews-stats/illustration-stat-01.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 800
      ...
      <div className="section-wrapper">
        <div className="section-header">
          <div className="section-header-text-container">
            <h2 className="section-header-title">The Importance of Reviews</h2>
          </div>
          <div className="section-header-img-container">
            <GatsbyImage
              image={getImage(section1Header)}
              alt="Five stars on a computer screen"
            />
            <div className="header-circle"></div>
          </div>
        </div>
        <ul className="stats-grid sg1">
          <li className="stat-block sg1-1">
            <p className="stat-block-copy">
              <span className="bold-class">
                Most consumers use Google reviews
              </span>{" "}
              to find businesses — 72%.
            </p>
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Most consumers use Google reviews to find businesses — 72%. via Chattermill">
                  <a
          ...
          <li className="stat-block sg1-2">
            <p className="stat-block-copy">
              <span className="bold-class">
                72% of Americans have written an online review
              </span>{" "}
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="72% of Americans have written an online review for a small business. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block alt-light-blue sg1-3">
            <p className="stat-block-copy">
              <span className="bold-class">93% of consumers</span> have used the
              internet to find a local business in the last year.
            </p>
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="93% of consumers have used the internet to find a local business in the last year. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg1-4">
            <p className="stat-block-copy">
              <span className="bold-class">67% of local businesses</span>{" "}
              maintain a four-star or higher average review rating.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="67% of local businesses maintain a four-star or higher average review rating. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg1-5">
            <p className="stat-block-copy">
              When looking at reviews, readers name{" "}
              <span className="bold-class">
                star rating the most important factor
              </span>
              , and quantity the least important.
            </p>
            <div className="stat-img-wrapper">
              <GatsbyImage
                image={getImage(statImg1)}
                alt="Speech bubbles with stars and happy faces"
              />
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="When looking at reviews, readers name star rating the most important factor, and quantity the least important. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg1-6">
            <p className="stat-block-copy">
              34% of shoppers{" "}
              <span className="bold-class">always read online reviews</span>,
              while only 13% never read reviews.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="34% of shoppers always read online reviews, while only 13% never read reviews. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block alt-dark-blue sg1-7">
            <p className="stat-block-copy">
              88% of Americans use online reviews to{" "}
              <span className="bold-class">discover new local businesses</span>.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="88% of Americans use online reviews to discover new local businesses. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg1-8">
            <p className="stat-block-copy">
              65% of consumers have read an online review{" "}
              <span className="bold-class">in the last week</span>.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="65% of consumers have read an online review in the last week. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg1-9">
            <p className="stat-block-copy">
              <span className="bold-class">Businesses average 83 reviews</span>{" "}
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Businesses average 83 reviews across online review sites. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg1-10">
            <p className="stat-block-copy">
              Businesses with at least 200 reviews{" "}
              <span className="bold-class">generate twice as much revenue</span>{" "}
              as others.
            </p>
            <div className="bottom-info-container">
              <a
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Businesses with at least 200 reviews generate twice as much revenue as others. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
