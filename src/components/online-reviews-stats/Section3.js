...
const Section3 = () => {
  const { section3Header, statImg3, statImg4 } = useStaticQuery(
    graphql`
      {
        section3Header: file(
          relativePath: {
            eq: "online-reviews-stats/illustration-header-section-03.png"
          }
        ) {
          childImageSharp {
            gatsbyImageData(
        ...
        statImg3: file(
          relativePath: { eq: "online-reviews-stats/illustration-stat-03.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 300
        ...
        statImg4: file(
          relativePath: { eq: "online-reviews-stats/illustration-stat-04.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 300
      ...
      <div className="section-wrapper">
        <div className="section-header">
          ...
          <div className="section-header-img-container">
            <GatsbyImage
              image={getImage(section3Header)}
              alt="A falling graph with sad faces around it"
            />
            <div className="header-circle"></div>
          </div>
        </div>
        <ul className="stats-grid sg3">
          <li className="stat-block sg3-1">
            <p className="stat-block-copy">
              <span className="bold-class">19% of online reviews</span> are
              negative.
            </p>
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="19% of online reviews are negative. via Chattermill">
                  <a
          ...
          <li className="stat-block alt-dark-blue sg3-2">
            <p className="stat-block-copy">
              Most people leave one-star reviews for bad service (59%), followed
              by{" "}
              <span className="bold-class">unsafe COVID-19 policies (26%)</span>
              .
            </p>
            <div className="stat-img-wrapper">
              <GatsbyImage
                image={getImage(statImg3)}
                alt="An angry face wearing a mask with germs floating around him"
              />
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Most people leave one-star reviews for bad service (59%), followed by unsafe COVID-19 policies (26%). via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg3-3">
            <p className="stat-block-copy">
              Just 9% of shoppers would consider buying from a business with a{" "}
              <span className="bold-class">two or one-star average review</span>
              .
            </p>
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Just 9% of shoppers would consider buying from a business with a two or one-star average review. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg3-4">
            <p className="stat-block-copy">
              A shopper is 21% more likely to leave a review{" "}
            ...
            <div className="stat-img-wrapper">
              <GatsbyImage
                ...
                alt="A speech bubble that says 21%"
              />
              <div className="stat-block-img-bg"></div>
            </div>
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="A shopper is 21% more likely to leave a review because of a negative experience than following a positive one. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg3-5">
            <p className="stat-block-copy">
              Negative phrases and sentiments are negative ranking factors,
              which{" "}
              <span className="bold-class">hurts visibility with Google</span>.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Negative phrases and sentiments are negative ranking factors, which hurts visibility with Google. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg3-6">
            <p className="stat-block-copy">
              <span className="bold-class">94% of consumers</span> have avoided
              a business because of an online review.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="94% of consumers have avoided a business because of an online review. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
