...
const Section5 = () => {
  const { section5Header, statImg6 } = useStaticQuery(
    graphql`
      {
        section5Header: file(
          relativePath: {
            eq: "online-reviews-stats/illustration-header-section-05.png"
          }
        ) {
          childImageSharp {
            gatsbyImageData(
        ...
        statImg6: file(
          relativePath: { eq: "online-reviews-stats/illustration-stat-06.png" }
        ) {
          childImageSharp {
            gatsbyImageData(
              width: 300
  ...
  return (
    <section id="section5" className="stat-section">
      <div className="section-wrapper">
        <div className="section-header">
          <div className="section-header-text-container">
            <h2 className="section-header-title">How to Get More Reviews</h2>
          </div>
          <div className="section-header-img-container">
            <GatsbyImage
              image={getImage(section5Header)}
              alt="Speech bubbles with the thubs-up sign and happy faces"
            />
            <div className="header-circle"></div>
          </div>
        </div>
        <ul className="stats-grid sg5">
          <li className="stat-block sg5-1">
            <p className="stat-block-copy">
              Local businesses who are proactive with their online reviews are{" "}
              <span className="bold-class">
                150% more likely to maintain an average rating of 4.5 or higher
              </span>
              .
            </p>
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Local businesses who are proactive with their online reviews are 150% more likely to maintain an average rating of 4.5 or higher. via Chattermill">
                  <a
          ...
          <li className="stat-block sg5-2">
            <p className="stat-block-copy">
              Consumers are 36% more likely to leave a review after a positive
              experience{" "}
              <span className="bold-class">when prompted through email</span>.
            </p>
            <div className="bottom-info-container">
              <a
                className="stat-block-source"
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Consumers are 36% more likely to leave a review after a positive experience when prompted through email. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg5-3">
            <p className="stat-block-copy">
              <span className="bold-class">Praising an excellent product</span>{" "}
              is the leading reason people leave reviews at 53%.
            </p>
            ...
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Praising an excellent product is the leading reason people leave reviews at 53%. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block sg5-4">
            <p className="stat-block-copy">
              <span className="bold-class">
                71% of consumers will leave a review
              </span>
              if they’re asked to.
            </p>
            <div className="bottom-info-container">
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="71% of consumers will leave a review if they’re asked to. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
          ...
          <li className="stat-block alt-light-blue sg5-5">
            <p className="stat-block-copy">
              <span className="bold-class">Employee attitude</span> is the
              biggest reason consumers leave one-star and five-star reviews,
              both answers at 85%.
            </p>
            <div className="bottom-info-container">
              <a
              ...
              <div className="stat-share-container">
                ...
                <CopyToClipboard text="Employee attitude is the biggest reason consumers leave one-star and five-star reviews, both answers at 85%. via Chattermill">
                  <a
                    className="stat-clipboard-icon"
                    onClick={handleShare.shareClip}
                  >
